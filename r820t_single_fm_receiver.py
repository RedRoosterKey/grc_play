...
class r820t_single_fm_receiver(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="R820T Single Fm Receiver")
        ...
        # Variables
        ##################################################
        self.tune_offset = tune_offset = 0
        self.center_freq = center_freq = 97.9e6
        self.tuned_in_to = tuned_in_to = center_freq+tune_offset
        ...
        # Blocks
        ##################################################
        _tune_offset_sizer = wx.BoxSizer(wx.VERTICAL)
        self._tune_offset_text_box = forms.text_box(
        	parent=self.GetWin(),
        	sizer=_tune_offset_sizer,
        	value=self.tune_offset,
        	callback=self.set_tune_offset,
        	label='tune_offset',
        	converter=forms.float_converter(),
        	proportion=0,
        )
        self._tune_offset_slider = forms.slider(
        	parent=self.GetWin(),
        	sizer=_tune_offset_sizer,
        	value=self.tune_offset,
        	callback=self.set_tune_offset,
        ...
        self.GridAdd(_tune_offset_sizer, 2, 0, 1, 100)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, -tune_offset, 1, 0)
...
# QT sink close method reimplementation
    ...
    def set_tune_offset(self, tune_offset):
        ...
        self.analog_sig_source_x_0.set_frequency(-self.tune_offset)
        self._tune_offset_slider.set_value(self.tune_offset)
        self._tune_offset_text_box.set_value(self.tune_offset)
        self.set_tuned_in_to(self.center_freq+self.tune_offset)
